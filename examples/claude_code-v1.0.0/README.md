...
```bash
valkyrie agent install path/to/github/url/examples/claude_code-v1.0.0
```
...
```bash
valkyrie run start --benchmark swebench --agent claude_code-v1.0.0 -s ANTHROPIC_API_KEY <AWS KEYNAME> --concurrency 10 --slice :10
```
